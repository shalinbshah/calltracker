...
public class AppMsg {
	 ...
	 * style.
	 */
	public static final Style STYLE_ALERT = new Style(LENGTH_LONG,
			R.color.alert);
	...
	/**
	 * @author mengguoqiang 扩展支持设置字体大小 Make a {@link AppMsg} that just contains
	 *         a text view.
	 * 
	 * @param context
	 *            The context to use. Usually your {@link android.app.Activity}
	...
	/**
	 * @author mengguoqiang 扩展支持字体大小 Make a {@link AppMsg} with a custom layout.
	 *         The layout must have a {@link TextView} com id
	...
	/**
	 * 
	 * @author mengguoqiang 扩展支持设置字体大小 Make a {@link AppMsg} with a custom view.
	 *         It can be used to create non-floating notifications if floating
	 *         is false.
	 * 
	 * @param context
	 *            The context to use. Usually your {@link android.app.Activity}
