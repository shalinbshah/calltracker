...
public class SelectGroupPopUp extends BaseActivity {
    ...
    public class GetCollectionListFromWebService extends
        ...
        protected void onPreExecute() {
            ...
            progressDialog = new MyProgressDialog(SelectGroupPopUp.this);
            progressDialog.show();
        }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        albumsListAdapter = new ContactGroupListAdapter(this, getIntent(),
